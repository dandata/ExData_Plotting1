...
png(file='plot4.png')
par(mfcol=c(2, 2))
plot(data.play$Datetime, as.numeric(data.play$Global_active_power), main="", type="l", ylab="Global Active Power", xlab="")
...
legend("topright", legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col=c("#000000", "#ff0000", "#0000ff"), lwd=1, bty="n")
plot(data.play$Datetime, as.numeric(data.play$Voltage), main="", type="l", ylab="Voltage", xlab="datetime")
plot(data.play$Datetime, as.numeric(data.play$Global_reactive_power), main="", type="l", ylab="Global_reactive_power", xlab="datetime")
dev.off()